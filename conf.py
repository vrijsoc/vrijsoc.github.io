...
BLOG_AUTHOR = "vrijsoc"  # (translatable)
BLOG_TITLE = "De Vrij Socialistische Student"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://vrijsoc.github.io/blog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "vrijsoc@tuta.io"
...
# (translatable)
CONTENT_FOOTER = 'Gemaakt met <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
